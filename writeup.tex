...
\includegraphics[width=0.5\textwidth]{images/VBallMediumSurf1.png}
\includegraphics[width=0.5\textwidth]{images/VBallMediumSurf2.png}
A volleyball reconstructed using SURF shown from two angles.\\
\includegraphics[width=0.5\textwidth]{images/VBallMediumSift1.png}
\includegraphics[width=0.5\textwidth]{images/VBallMediumSift2.png}
