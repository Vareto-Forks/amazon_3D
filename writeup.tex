...
Our experiments take the concepts presented by the Snavel Photo Tourism paper and test the limits to which these concepts can be applied, by attempting to reconstruct products on Amazon. Product photos on Amazon present a number of challenges which make the reconstruction process difficult. IDK WHAT ELSE TO WRITE HERE WITHOUT GETTING INTO ERROR ANALYSIS - WHICH I DONT THINK IS WHAT WE WANT TO DO HERE
